...
var config = {
  ...
  site_title: 'Guía De Principiante Para Alquilar Un Auto en rennty.com',
  ...
  content_dir : path.join(__dirname, 'content-es'),

  // Where is the public directory or document root?
  public_dir  : path.join(__dirname, '..', 'themes', 'rennty', 'public', 'static'),
...
config.public_dir = path.join(__dirname, '..', 'themes', config.theme_name, 'public', 'static');
